...
# Omar El-Gayar
# This file should replace the corresponding file in nltk/corpus in the
# Python installation site-Packages.
# Scroll below for custom corpora specific code
...
###########
#Custom corpora (add as you add new corpora and revise as needed to experiment with different option)
cookbook = LazyCorpusLoader(
    'cookbook', WordListCorpusReader, r'(?!README|\.).*', encoding='ascii')
tudiab = LazyCorpusLoader(
    'tudiab', PlaintextCorpusReader, r'(?!README|\.).*', encoding='utf8')
###########


# nltk corpora (do NOT edit)
